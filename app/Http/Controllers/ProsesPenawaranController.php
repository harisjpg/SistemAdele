...
class ProsesPenawaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('ProsesPenawaran/Index', []);
    }

    public function getOfferPenawaran(Request $request)
    {
        $user = Auth::user();
        ...
        $query->where('t_offer.OFFER_IS_PENAWARAN', 1);
    ...
    public function getDetailProsesPenawaran(Request $request)
    {
        $arrOffer = TOffer::select(
            ...
            ->leftJoin('t_insurance', 't_insurance.INSURANCE_ID', '=', 't_offer_detail.INSURANCE_ID')
