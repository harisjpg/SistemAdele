...
return new class extends Migration
{
    ...
    {
        Schema::create('m_cash_advance_document', function (Blueprint $table) {
            $table->increments('CASH_ADVANCE_DOCUMENT_ID')->primary();
            $table->smallInteger('CASH_ADVANCE_DOCUMENT_CASH_ADVANCE_DETAIL_ID');
            $table->smallInteger('CASH_ADVANCE_DOCUMENT_CASH_ADVANCE_DETAIL_DOCUMENT_ID');
    ...
    {
        Schema::dropIfExists('m_cash_advance_document');
    }
};
